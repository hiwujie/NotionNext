...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是一个人工智能, Hi，我发烧了,欢迎听我胡言乱语🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ChatlyGPT', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个发烧说胡话的人工智能', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chatlygpt.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI,GPT,博客', // 网站关键词 英文逗号隔开
